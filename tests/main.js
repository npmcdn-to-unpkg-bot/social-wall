...
},{"./social-wall.js":12,"jquery":7}],12:[function(require,module,exports){
/**
 * social-wall - 0.4.3
...
var social = {
	...
	showPosts:function(page, state){
		function showThePostsInit(){
			...
			if($(".social_page_1").length === 0){
				...
				setTimeout(function(){
					...
					//console.log('Duration after displaying everything : ' + (last - first) + 'ms');
				}, 2000);
		...
		if(state === "loadInit"){
			...
			//console.log('Duration for the loading : ' + (med - first) + 'ms');
			if($loaderElement.attr("id") === "social_loading"){
				$loaderElement.delay(1000).animate({
					'opacity': 0},
					500, function() {
					showThePostsInit();
				});
...
},{"imagesloaded":5,"jquery":7,"jquery-bridget":6,"masonry-layout":8}]},{},[12,11]);
